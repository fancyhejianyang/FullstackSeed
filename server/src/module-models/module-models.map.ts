  ...
  demo: {
    ...
    fields: withBaseFields([
      ...
      },
      {
        ...
        required: false,
        length: 20,
        enumValues: ['original', 'reprint', 'translation'],
      ...
      },
      {
        ...
        required: false,
        nullable: true,
        description: 'demo 页面使用 DatePicker',
      },
      {
        prop: 'activeRange',
        label: '有效期',
        ...
        required: false,
        nullable: true,
        description: 'demo 页面使用 DateRange',
      },
      {
        prop: 'contactPhone',
        label: '联系电话',
      ...
      },
      {
        ...
        required: false,
        defaultValue: 0,
        description: 'demo 页面使用 InputNumber',
      },
      {
        prop: 'unitPrice',
        label: '单价',
        ...
        required: false,
        defaultValue: 0,
        description: 'demo 页面使用 InputNumber 的金额模式',
      },
      {
        prop: 'budgetAmount',
        label: '预算金额',
        ...
        required: false,
        defaultValue: 0,
        description: 'demo 页面使用 InputAmount，支持按总金额切换百分比输入',
      },
      {
        prop: 'isFeatured',
        label: '是否推荐',
      ...
      },
      {
        ...
        required: false,
        defaultValue: true,
        description: 'demo 页面使用 Checkbox',
      },
      {
        prop: 'tags',
        label: '标签',
      ...
      },
      {
        ...
        required: false,
        nullable: true,
        description: 'demo 页面使用 CheckboxGroup',
      },
      {
        prop: 'imageUrl',
        label: '封面图片',
        ...
        required: false,
        nullable: true,
        description: 'demo 页面使用 UploadImage',
      },
      {
        prop: 'attachmentName',
        label: '附件名称',
      ...
      },
      {
        ...
        required: false,
        nullable: true,
        description: 'demo 页面使用 UploadFile',
      },
    ]),
  },
};
